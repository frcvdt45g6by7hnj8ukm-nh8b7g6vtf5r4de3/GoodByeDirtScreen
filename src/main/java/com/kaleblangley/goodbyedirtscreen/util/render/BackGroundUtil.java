...
public class BackGroundUtil {
    ...
    public static boolean allowScreen(Screen screen) {
        return GoodByeDirtScreen.ALLOW_SCREEN_LIST.get().contains(screen.getClass().getName());
    }

    public static boolean excludeScreen(Screen screen) {
        return GoodByeDirtScreen.EXCLUDE_SCREEN_LIST.get().contains(screen.getClass().getName());
    }
